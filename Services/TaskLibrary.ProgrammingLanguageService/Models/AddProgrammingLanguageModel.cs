...
{
    public class AddProgrammingLanguageModel
    {
    ...
    public class AddProgrammingLanguageModelValidator : AbstractValidator<AddProgrammingLanguageModel>
    {
        public AddProgrammingLanguageModelValidator()
        {
            RuleFor(x => x.Name)
    ...
    public class AddProgrammingLanguageModelProfile : Profile
    {
        public AddProgrammingLanguageModelProfile()
        {
            CreateMap<AddProgrammingLanguageModel, ProgrammingLanguage>();
        }
    }
}
